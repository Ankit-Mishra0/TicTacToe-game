...
const checkWinner=()=>{
    for(let pattern of winPattern){
        if((boxex[pattern[0]].innerText===boxex[pattern[1]].innerText&&boxex[pattern[1]].innerText===boxex[pattern[2]].innerText)&&boxex[pattern[0]].innerText!=""){
            document.querySelector("h1").innerText=`winner is ${boxex[pattern[0]].innerText}`;
